...
export function LoginForm({
  ...
  const handleSocialLogin = (platform: string) => {
    toast.info(`O login via ${platform} está indisponível para esta demonstração.`);
  };
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <FieldGroup>
              ...
              <Field className="grid grid-cols-3 gap-4">
                ...
                <Button variant="outline" type="button" onClick={() => handleSocialLogin("Meta")}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
              ...
              <FieldDescription className="text-center text-xs">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    toast.info("A criação de novas contas deve ser solicitada à equipe de NOC.");
                  }}
                >
                  Cadastre-se
                </a>
